...
//        }
        ...
        mapDefault[4] = new int[]{17,21,18,18,19,23,20,20, 3, 3,12,16,21,21,30,34};
        mapDefault[5] = new int[]{21,17,22,22,23,19,24,24, 7, 8,12,17,25,26,30,31};
        mapDefault[6] = new int[]{25,25,26,26,27,27,28,28, 4, 8,13,17,22,26,35,35};
        mapDefault[7] = new int[]{29,33,30,34,31,35,32,32, 4, 9,13,18,22,27,31,32};
        mapDefault[8] = new int[]{33,29,30,34,35,31,36,36, 5, 9,14,18,23,27,36,36};
    }
